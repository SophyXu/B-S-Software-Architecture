...
function winGame(){
	...
	if(count<2){
		if(winner == 1){
			socket.emit('score', {'click_list': 1});
			alert("�ڷ���ʤ��");
		}
		else {
			socket.emit('score', {'click_list': 2});
			alert("�췽��ʤ��");
		}
	}
}
...
function checkWhichSide(string){
	if(string == "܇"||string == "��" ||string == "��"||string == "ʿ"||string == "��"||string == "��" ||string == "��" )
		return 1;
	if(string == "��"||string == "�R" ||string == "��"||string == "��"||string == "��"||string == "��" ||string == "��" )
		return 2;
}
